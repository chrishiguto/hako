...
- `docs/adr/0006-engine-as-library-six-seams.md` — ADR (Accepted, amended) — Engine never depends on server/api; six trait seams, five of them reached by a kernel through the context; secrets resolve once at submit into a value. Topics: crates, dependencies, seams, testing, secrets.
