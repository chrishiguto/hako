...
- `docs/adr/0007-progress-report-verified-done.md` — ADR (Accepted) — Schema-validated stage reports are the agent→engine channel; done requires a skeptic pass. Topics: stage report, progress, verified done, skeptic, schema.
