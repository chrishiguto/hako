...
- `docs/adr/0006-engine-as-library-six-seams.md` — ADR (Accepted, amended) — Engine never depends on server/api; RunSpawner is the seventh seam, five collaborators reach kernels through context, and secrets resolve once at submit. Topics: crates, dependencies, seams, testing, secrets, fanout.
